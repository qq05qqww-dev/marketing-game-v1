      ...
      <div class="grid gap-0 xl:grid-cols-[1fr_0.72fr]">
        <div class="bg-gradient-to-br from-slate-950 via-orange-950 to-slate-900 p-6 text-white">
          <p class="text-xs font-black uppercase tracking-[0.24em] text-orange-200">
            Wheel Admin Center｜第 48801～49200 批
          </p>
      ...
      <div class="space-y-6">
        <section class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
          <div class="mb-5 flex items-start justify-between gap-4">
            <div>
              <p class="text-xs font-black uppercase tracking-[0.2em] text-orange-500">Basic Text</p>
        ...
        <section class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-orange-500">Visual Theme</p>
        ...
        <section class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
          <p class="text-xs font-black uppercase tracking-[0.2em] text-orange-500">Display Options</p>
          ...
          <div class="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            <label v-for="(value, key) in settings.display" :key="key" class="flex items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-black text-slate-700">
              <span>{{ key }}</span>
              <input v-model="settings.display[key]" type="checkbox" class="h-5 w-5 rounded border-slate-300 text-orange-500" />
            </label>
          </div>
        </section>
